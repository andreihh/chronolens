...
public data class Identifier(private val identifier: String) : SourceNodeId {
  ...
  public companion object {
    ...
    @JvmStatic public fun isValid(identifier: String): Boolean = identifier.matches(identifierRegex)
  }
}
...
public data class Signature(private val signature: String) : SourceNodeId {
  ...
  public companion object {
    ...
    @JvmStatic public fun isValid(signature: String): Boolean = signature.matches(signatureRegex)
  }
}
