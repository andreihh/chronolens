...
private constructor(
  ...
  public operator fun get(path: SourcePath): SourceFile? = getOrNull(path)
...
internal inline fun <reified T : SourceNode> NodeHashMap.getSourceNode(
  id: QualifiedSourceNodeId<T>
): T = this[id]?.sourceNode as T
