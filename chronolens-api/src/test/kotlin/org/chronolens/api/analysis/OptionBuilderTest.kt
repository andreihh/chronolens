...
class OptionBuilderTest {
  ...
  fun nullable_whenNotProvided_returnsNull() {
    ...
    val option by
      optionsProvider.option<Int>().name("abc").alias("a").description("simple int").nullable()
  ...
  fun required_whenNotProvided_throws() {
    ...
    assertFails {
      optionsProvider.option<Int>().name("abc").alias("a").description("simple int").required()
    }
  }
  ...
  fun default_whenNotProvided_returnsDefault() {
    ...
    val option by
      optionsProvider.option<Int>().name("abc").alias("a").description("simple int").defaultValue(5)
  ...
  fun default_whenBothNameAndAliasProvided_throws() {
    ...
    assertFails {
      optionsProvider.option<Int>().name("abc").alias("a").description("simple int").defaultValue(7)
    }
  }
  ...
  fun repeated_whenBothNameAndAliasProvided_throws() {
    val optionsProvider =
      OptionsProviderBuilder().setOption("abc", listOf(1, 3)).setOption("a", listOf(2, 5)).build()
