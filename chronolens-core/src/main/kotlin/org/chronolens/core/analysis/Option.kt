...
public interface Option<T> {
    ...
    public companion object {
        /**
         * Delegates to [Option.validate] to ensure the option value is within the ([min], [max])
         * range. Skips the corresponding check if [min] or [max] are `null`.
         */
        @JvmStatic
        ...
        /**
         * Throws an [InvalidOptionException] with the given [lazyMessage] if [condition] is
         * `false`.
         */
        @JvmStatic
