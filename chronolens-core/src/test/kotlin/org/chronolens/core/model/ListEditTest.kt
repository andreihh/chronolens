...
import org.chronolens.core.model.ListEdit.Add
import org.chronolens.core.model.ListEdit.Companion.apply
import org.chronolens.core.model.ListEdit.Remove
...
class ListEditTest {
    ...
    @Test
    fun `test add element before end`() {
        val expected = "12345"
    ...
    @Test
    fun `test add element in middle`() {
        val expected = "12345"
    ...
    @Test
    fun `test remove middle element`() {
        val expected = "1245"
