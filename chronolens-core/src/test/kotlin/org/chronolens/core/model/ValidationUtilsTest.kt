...
class ValidationUtilsTest {
    ...
    @Test fun `test nested type id with correct separators is valid`() {
        validateTypeId("src/Test.java:IClass:InnerClass")
    }

    @Test fun `test nested type id with path separator throws`() {
        assertFailsWith<IllegalArgumentException> {
            validateTypeId("src/Test.java:IClass/InnerClass")
        }
    }

    @Test fun `test function id with path separator throws`() {
        assertFailsWith<IllegalArgumentException> {
    ...
    @Test fun `test variable id with parentheses throws`() {
        assertFailsWith<IllegalArgumentException> {
            validateVariableId("Test.java:version()")
        }
    }
    ...
    @Test fun `test valid type id is valid node id`() {
