...
sealed class SourceNode {
     ...
     * @throws IllegalArgumentException if the `id` is not valid or if the
     * ids of the `entities` are not valid or if the `entities` contain
     * duplicated ids
     */
    ...
    sealed class SourceEntity : SourceNode() {
         ...
         * contained types)
         * @throws IllegalArgumentException if the `id` is not valid or if the
         * ids of the `members` are not valid or if the `members` contain
         * duplicated ids
         */
        data class Type(
                override val id: String,
         ...
         * @property body the body lines of this function, or an empty list if
         * it doesn't have a body
         * @throws IllegalArgumentException if the `id` is not valid or if the
         * ids of the `parameters` are not valid or if the `parameters` contain
         * duplicated ids
         */
        data class Function(
                override val id: String,
             ...
             *
             * The signature of a function should be `name(type_1, type_2, ...)`
             * if function overloading at the type level is allowed, or
             * `name(n)` (where `n` is the arity of the function) if function
             * overloading at the arity level is allowed, or `name()` otherwise.
             */
         ...
         * @property initializer the initializer lines of this variable, or an
         * empty list if it doesn't have an initializer
         */
        data class Variable(
                override val id: String,
                val modifiers: Set<String> = emptySet(),
